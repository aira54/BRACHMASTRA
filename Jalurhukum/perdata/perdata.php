...
<div class="max-w-6xl mx-auto py-10 px-4">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="toko-hukum-perdata.php" class="block rounded-lg overflow-hidden shadow-lg hover:scale-105 transform transition sm:col-span-3">
        ...
        <!-- Konsultasi -->
        <a href="konsultasi-perdata.php" class="block rounded-lg overflow-hidden shadow-lg hover:scale-105 transform transition sm:col-span-2">
        ...
        <!-- Berita -->
        <a href="berita-perdata.php" class="block rounded-lg overflow-hidden shadow-lg hover:scale-105 transform transition sm:col-span-1">
