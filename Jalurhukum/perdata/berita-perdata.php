...
$query = "SELECT * FROM berita WHERE kategori = 'perdata' ORDER BY tanggal DESC";
...
<section class="max-w-5xl mx-auto p-4">
    <h2 class="text-2xl font-bold mb-6">Berita Perdata Terbaru</h2>
     ...
     class="w-full h-40 object-cover">
                ...
                <div class="p-4">
                    ...
                    <p class="text-sm text-gray-600 mb-3"><?php echo substr($row['isi'], 0, 80) . '...'; ?></p>
                                      <a href="../../detail-berita.php?id=<?php echo $row['id']; ?>&from=perdata" class="text-blue-600">Baca Selengkapnya</a>
