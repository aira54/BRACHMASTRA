...
$queryGratis = "SELECT * FROM pengacara WHERE spesialis = 'Hukum bisnis' AND tipe_konsultasi = 'gratis'";
$queryBerbayar = "SELECT * FROM pengacara WHERE spesialis = 'Hukum bisnis' AND tipe_konsultasi = 'berbayar'";
...
<div class="mt-12 px-4 max-w-6xl mx-auto">
  <h2 class="text-2xl font-bold mb-6 text-center">Konsultasi Hukum bisnis</h2>
    ...
    <?php if ($resultGratis && $resultGratis->num_rows > 0): ?>
      <?php while ($row = $resultGratis->fetch_assoc()): ?>
        ...
        <div class="bg-gray-50 rounded-lg shadow p-6 flex flex-col items-center">
         ...
         <a href="../../popup-konsultasi.php?id=<?= $row['id'] ?>&from=bisnis" 
